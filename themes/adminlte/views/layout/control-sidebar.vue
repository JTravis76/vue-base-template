<template>
    <aside class="control-sidebar control-sidebar-dark" v-bind:class="[open ? 'control-sidebar-open' : '']">
        <!-- Create the tabs -->
        <ul id="control-sidebar" class="nav nav-tabs nav-justified control-sidebar-tabs">
